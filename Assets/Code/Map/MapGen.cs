...
public class MapGen : MonoBehaviour
{
    ...
    private GameObject CalculateRiverTile(Coordinate coord)
    {
        ...
        if (tileData.RiverConnections.Count == 1 || (tileData.RiverConnections.Count == 2 && GridHelper.AreOpposite(tileData.RiverConnections[0], tileData.RiverConnections[1])))
        {
        ...
        else if (tileData.RiverConnections.Count == 2 && !GridHelper.AreOpposite(tileData.RiverConnections[0], tileData.RiverConnections[1]))
        {
            switch (tileData.RiverConnections.First())
            {
                case Compass.East:
